...
<aside id="secondary" class="widget-area site-column sidebar">
		<div class="sidecontent">
				...
				<div class="sidenav">
					<p>
						<i class="fa fa-plus-circle"></i>Bläddra bland kanaler
					</p>
				</div>

				<div class="sidenav">
					<p>Logga in nu om du vill se dina kanaler och rekomenderationer!  <a href="#">LOGGA IN</a></p>
				</div>
				...
				<div class="sidenav">
					...
					<p>
						<a href="#">Om press</a>
						<a href="#">Upphovsrätt</a>
						<a href="#">Kontakta oss</a>
						<a href="#">Innehållsskapare</a>
						<a href="#">Annonsera</a>
						<a href="#">Utvecklare</a>
						<br>
						<a href="#">Vilkor</a>
						<a href="#">Sekretess</a>
						<a href="#">Policy & säkerhet</a>
