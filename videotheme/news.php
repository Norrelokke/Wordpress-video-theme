...
<?php require('sidebar.php') ?>
  <div class="topnewshead"></div>
        <div class="newshead"><i class="fa fa-paste"></i> <?php the_title();?>
            ...
            <div class="main-news">
                <div class="post">
                        ...
                        ?>
                          ...
                          <div class="newstext">
                                  <h2>Topnyheter</<h2>
                                  <p>Lorem ipsum dolor amet synth organic shabby chic adaptogen. Vice poutine before they sold out la croix small batch narwhal. Marfa woke scenester selfies lo-fi organic gentrify.Kombucha locavore distillery af taiyaki.Post-ironic ramps VHS sustainable, cold-pressed letterpress ugh 3 wolf moonkeytar yr pickled single-origin coffee PBR&B. DIY palo santo slow-carb try-hard jean shorts neutra mixtape actually lo-fi</p>
                          </div>
